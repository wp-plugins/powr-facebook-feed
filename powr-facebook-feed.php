<?php
    /**
     * @package POWr Facebook Feed
     * @version 1.1
     */
    /*
    Plugin Name: POWr Facebook Feed
    Plugin URI: http://www.powr.io
    Description: Create a custom Facebook feed in seconds! Add the widget to your theme, or create a Facebook Feed on ANY page or post by using the shortcode [powr-facebook-feed]. Then, simply visit your site and click the settings icon to customize your Facebook Feed right in the page. Many more plugins & tutorials at POWr.io.
    Author: POWr.io
    Version: 1.1
    ...
    */
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////Create Facebook Feed widget/////////////////////////////////
    class Powr_Facebook_Feed extends WP_Widget{
      //Create the widget
      public function __construct(){
        parent::__construct( 'powr_facebook_feed',
                             __( 'POWr Facebook Feed' ),
                             array( 'description' => __( 'Facebook Feed by POWr.io') )
        );
      }
      //This prints the div
      public function widget( $args, $instance ){
        ...
        ?>
        <div class='widget powr-facebook-feed' label='<?php echo $label; ?>'></div>
        <?php
      }
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Facebook Feed.
        </p>
        <p>
    ...
    function register_powr_facebook_feed() {
      register_widget( 'Powr_Facebook_Feed' );
    }
    //Use widgets_init action hook to execute custom function
    add_action( 'widgets_init', 'register_powr_facebook_feed' );
    //Create short codes for adding plugins anywhere:
    function powr_facebook_feed_shortcode( $atts ){
      if(isset($atts['label'])){
        $label = $atts['label'];
      }else{
        $label = '';
      }
      return "<div class='powr-facebook-feed' label='$label'></div>";
    }
    add_shortcode( 'powr-facebook-feed', 'powr_facebook_feed_shortcode' );
  ?>